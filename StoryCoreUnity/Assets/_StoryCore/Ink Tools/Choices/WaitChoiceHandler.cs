    ...
    public class WaitChoiceHandler : ChoiceHandler {
        ...
        public override void ReadyAndWaiting() {
            ...
            if (IsPaused) {
                ...
                StoryDebug.Log($"Found [{m_Choice.Key}] choice, but paused. Waiting for Resume() and {m_Duration} seconds", this);
                return;
            }

            StoryDebug.Log($"Found [{m_Choice.Key}] choice. Waiting for {m_Duration} seconds", this);
