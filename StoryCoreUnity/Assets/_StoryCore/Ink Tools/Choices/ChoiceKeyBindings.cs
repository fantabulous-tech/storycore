...
namespace StoryCore.Choices {
    ...
    public class ChoiceKeyBindings : BaseBucket {
        ...
        public void Init() {
            ...
            m_GameEventToChoiceText = m_Bindings.Where(b => b.GameEvent).ToDictionary(b => b.GameEvent, b => b.ChoiceKey);
        }
        ...
        public string this[BaseGameEvent gameEvent] => gameEvent && m_GameEventToChoiceText != null && m_GameEventToChoiceText.TryGetValue(gameEvent, out string choiceName) ? choiceName : null;
