...
namespace Polyglot
{
    ...
    public class LocalizationInspector : Editor
    {
        ...
        // https://docs.google.com/spreadsheets/d/1AzxxvLbFafQNMc7wGey7nPtchNiFuInJJ0jE7NyQ2Xs/edit#gid=296134756
        private const string OfficialSheet = "1AzxxvLbFafQNMc7wGey7nPtchNiFuInJJ0jE7NyQ2Xs";
        ...
        public override void OnInspectorGUI()
        {
            ...
            DisplayDocsAndSheetId("Master Sheet", false, false, masterSheet, serializedObject.FindProperty("polyglotDocument"), OfficialSheet, OfficialGId, polyglotPath, DownloadMasterSheet);
        ...
        private static void DisplayDocsAndSheetId(string title, bool disableId, bool disableOpen, LocalizationAsset sheet, SerializedProperty document, string defaultDocs, string defaultSheet, string defaultTextAssetPath, Action download)
        {
            ...
            bool doDownload = GUILayout.Button("Download");
