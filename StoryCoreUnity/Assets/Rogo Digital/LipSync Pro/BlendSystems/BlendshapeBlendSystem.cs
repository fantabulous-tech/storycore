...
namespace RogoDigital.Lipsync
{
	public class BlendshapeBlendSystem : BlendSystem
	{
		...
		public override void SetBlendableValue (int blendable, float value)
		{
			...
			if (characterMesh.sharedMesh.blendShapeCount < blendable)
			{
				Debug.LogWarning($"No blendshape #{blendable} on {name}", this);
				return;
			}
		...
		public override string[] GetBlendables ()
		{
			...
			if (blendableCount == 0 || blendableCount < blendShapes.Length)
				setInternal = true;
