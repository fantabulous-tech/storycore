...
#pragma warning restore 618
	...
	void OnSaveAsClick ()
	{
		...
		string defaultPath = "Assets" + lastLoad;

		if (Clip != null)
		{
			defaultName = Clip.name;
			defaultPath = Path.GetDirectoryName(AssetDatabase.GetAssetPath(Clip));
		}

		string savePath = EditorUtility.SaveFilePanel("Save LipSync Data File", defaultPath, defaultName + ".asset", "asset");
		if (savePath != "")
		{
